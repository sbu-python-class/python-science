...
\hypersetup{
  pdftitle={PHY 546: Python for Scientific Computing (Spring 2026)},
  pdflang={en-US}
}

% don't number sections but include them in the TOC
...
of active research, by learning how to apply python to problems in
your field.
...
\section{Course Topics and Following Along}
...
\begin{itemize}
\item {\sf A\phantom{+}}: 12 (meaningful) postings to slack

\item {\sf A$-$}: 9 (meaningful) postings to slack

\item {\sf B$+$}: 6 postings to the slack
